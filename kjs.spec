...
Version  : 5.108.0
Release  : 63
URL      : https://download.kde.org/stable/frameworks/5.108/portingAids/kjs-5.108.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.108/portingAids/kjs-5.108.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.108/portingAids/kjs-5.108.0.tar.xz.sig
...
%prep
%setup -q -n kjs-5.108.0
cd %{_builddir}/kjs-5.108.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688855672
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5JS.so.5.108.0
/V3/usr/lib64/libKF5JSApi.so.5.108.0
/usr/lib64/libKF5JS.so.5
/usr/lib64/libKF5JS.so.5.108.0
/usr/lib64/libKF5JSApi.so.5
/usr/lib64/libKF5JSApi.so.5.108.0
