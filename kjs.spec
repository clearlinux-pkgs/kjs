...
Source0  : https://download.kde.org/stable/frameworks/5.99/portingAids/kjs-5.99.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.99/portingAids/kjs-5.99.0.tar.xz.sig
...
%prep
%setup -q -n kjs-5.99.0
cd %{_builddir}/kjs-5.99.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665411737
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5JS.so.5.99.0
/usr/lib64/libKF5JSApi.so.5
/usr/lib64/libKF5JSApi.so.5.99.0
