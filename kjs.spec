...
Source0  : https://download.kde.org/stable/frameworks/5.49/portingAids/kjs-5.49.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.49/portingAids/kjs-5.49.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1534098633
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKF5JS.so.5.49.0
/usr/lib64/libKF5JSApi.so.5
/usr/lib64/libKF5JSApi.so.5.49.0
