...
Source0  : https://download.kde.org/stable/frameworks/5.76/portingAids/kjs-5.76.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.76/portingAids/kjs-5.76.0.tar.xz.sig
...
%prep
%setup -q -n kjs-5.76.0
cd %{_builddir}/kjs-5.76.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605425873
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kjs-5.76.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kjs/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5JS.so.5.76.0
/usr/lib64/libKF5JSApi.so.5
/usr/lib64/libKF5JSApi.so.5.76.0
