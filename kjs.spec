...
Source0  : https://download.kde.org/stable/frameworks/5.48/portingAids/kjs-5.48.0.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1532440182
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKF5JS.so.5.48.0
/usr/lib64/libKF5JSApi.so.5
/usr/lib64/libKF5JSApi.so.5.48.0
